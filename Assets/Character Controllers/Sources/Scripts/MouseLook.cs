...
//
		...
		{
			float rotationX = transform.localEulerAngles.y + Input.GetAxis("Mouse X" + xrot) * sensitivityX;
//			float rotationX = transform.localEulerAngles.y + inputDevice.RightStickX * sensitivityX;;

			rotationY += Input.GetAxis("Mouse Y" + yrot) * sensitivityY;
...
//			rotationY += inputDevice.RightStickY * sensitivityY;
		...
		{
			transform.Rotate(0, Input.GetAxis("Mouse X" + xrot) * sensitivityX, 0);
//			transform.Rotate(0, inputDevice.RightStickX * sensitivityX, 0);
